...
iot_wss.on('connection', ws => {
    ws.on('message', m => {
        ...
        if (data.message !== undefined && data.message.door !== undefined && data.message.food !== undefined && data.message.water.level !== undefined && data.message.water.turbidity !== undefined) {
            ...
            app_wss.clients.forEach(client => client.send(JSON.stringify({ message: { door: (0, door_1.getDoor)(), food: { Kg: (0, food_1.getKg)(), fullKg: (0, food_1.getFullKg)() }, water: { level: (0, waterLevel_1.getWaterLevel)(), turbidity: (0, waterLevel_1.getWaterLevel)() } } })));
        }
        else {
